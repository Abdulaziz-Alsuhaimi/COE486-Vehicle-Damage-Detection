...
python!pip install ultralytics -q
...
pythonkaggle_token = "YOUR_KAGGLE_TOKEN_HERE"
...
pythonbaseline_model = YOLO('yolov8s.pt')
...
Download best.pt from the project Google Drive (link provided separately)
...
MetricBaseline YOLOv8sYOLOv8s + CBAMImprovementmAP@0.50.4270.598▲ 40.0%mAP@0.5:0.950.2720.469▲ 72.2%Precision0.4340.635▲ 46.2%Recall0.4310.566▲ 31.4%

Per-Class mAP@0.5 (CBAM Model)

ClassmAP@0.5dent0.420scratch0.437crack0.096glass shatter0.974lamp broken0.751tire flat0.906
...
Ma, "YOLOv5-CBAM: A Small Object Detection Model," IEEE RICAI 2024
Agrawal et al., "Advanced Car Damage Assessment Using YOLOv8," ResearchGate 2025
Wang et al., "CarDD: A New Dataset for Vision-Based Car Damage Detection," IEEE Trans. ITS 2023
